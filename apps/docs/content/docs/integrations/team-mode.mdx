...
> **Status:** Phase 1 implemented — multi-user auth, role-based permissions, audit logging. Phase 2 (per-user identity anchors) in progress.
...
- [Architecture proposal](https://github.com/the-brain-dev/The-Brain/blob/main/references/team-mode-architecture.md) — Full design document
