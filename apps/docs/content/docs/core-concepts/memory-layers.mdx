...
<Mermaid chart={`\ngraph TB\n    subgraph INSTANT["⚡ INSTANT — Graph Memory"]\n        A1["AFTER_RESPONSE handler"]\n    end\n\n    subgraph CURATOR["⚖️ Data Curator — Quality Gate"]\n        H["Heuristics Gate"]\n        J["LLM Judge"]\n        R["LLM Rewriter"]\n        H -->|"pass"| J\n        J -->|"score ≥ 6"| R\n    end\n\n    subgraph SPM["⚖️ SPM Curator — Surprise Gate"]\n        C1["Composite Surprise Score"]\n        C2["Score > Threshold?"]\n        C1 --> C2\n    end\n\n    subgraph DEEP["🌌 DEEP — Consolidation"]\n        D1["DEEP_CONSOLIDATE (2 AM cron)"]\n        D2["MLX LoRA Training"]\n        D3["Auto-Wiki Generation"]\n    end\n\n    A1 -->|"ON_INTERACTION"| H\n    R -->|"cleaned interaction"| C1\n    C2 -->|"yes — SELECTION_PROMOTE"| D1\n    C2 -->|"no"| X["Discarded"]\n    D1 --> D2\n    D1 --> D3\n\n    style INSTANT fill:#4a1942,stroke:#fb7185,color:#fff\n    style CURATOR fill:#1e3a5f,stroke:#60a5fa,color:#fff\n    style SPM fill:#3b1f3b,stroke:#c084fc,color:#fff\n    style DEEP fill:#2d1b4e,stroke:#a78bfa,color:#fff\n    style X fill:#3f1a1a,stroke:#ef4444,color:#fff\n`}/>
