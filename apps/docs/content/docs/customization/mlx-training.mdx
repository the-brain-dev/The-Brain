...
ollama create the-brain-model --from gemma4:4b --adapter ~/.the-brain/lora-checkpoints/adapter.safetensors

# Use it
ollama run the-brain-model
```
...
1. Download `gemma-4-4b-it` from LM Studio
