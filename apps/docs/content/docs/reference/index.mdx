...
All CLI commands with every flag and option. 16 commands: init, daemon, consolidate, inspect, train, context, health, wiki, dashboard, timeline, backend, plugins, mcp, agent, user, ext.
