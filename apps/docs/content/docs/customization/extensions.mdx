...
The `@the-brain/plugin-harvester-hermes` plugin harvests conversations from Hermes Agent. The example below shows key extension-programming techniques used to build this harvester.
