...
```json
{
  "mlx": {
    "enabled": true,
    "modelPath": "mlx-community/gemma-4-e4b-it-OptiQ-4bit",
...
- **At 2 AM**: SPM has promoted the surprising, high-value memories to the DEEP layer. MLX training runs — ~50 iterations on your consolidated memories — producing `adapter.safetensors`.
