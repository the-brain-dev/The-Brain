/**
 * @my-brain/plugin-auto-wiki — v2.0.0
 *
 * Karpathy-style LLM Wiki generator for my-brain.
 * Inspired by:
...
import type { BrainDB, Memory, GraphNodeRecord } from "@my-brain/core";
...
> Auto-generated by my-brain plugin-auto-wiki.
...
export function createAutoWikiPlugin(
  ...
  async function generateRawDump(memories: Memory[]): Promise<WikiPage> {
    ...
    body += `\n---\n*Generated by my-brain plugin-auto-wiki*\n`;
  ...
  async function generateWeeklySummary(
    ...
    body += `---\n\n*Generated by my-brain — Cognitive OS for AI Agents*\n`;
  ...
  const plugin = definePlugin({
    name: "@my-brain/plugin-auto-wiki",
    version: "2.0.0",
    description:
    ...
    // Expose for direct CLI invocation (my-brain wiki generate)
