...
> The extensions below were the project's **research starter pack**. This package list is preserved for reference; community extension development is no longer active.
