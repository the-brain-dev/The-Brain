/**
 * Tests for @my-brain/plugin-spm-curator — Selection Layer
 */
import { describe, test, expect, beforeEach } from "bun:test";
import { createSpmCurator, SpmCuratorPlugin } from "../index";
import { MemoryLayer, HookEvent } from "@my-brain/core";
import type { InteractionContext, SurpriseGateResult, MemoryFragment } from "@my-brain/core";
...
describe("createSpmCurator", () => {
  test("returns definition and instance", () => {
    ...
    expect(definition.name).toBe("@my-brain/plugin-spm-curator");
