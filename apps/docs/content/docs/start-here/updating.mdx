---
title: Updating the-brain (Archived)
description: Historical the-brain update notes
---

> **DEPRECATED — PROJECT ARCHIVED.** There is no supported update channel or maintained release path. The procedures below are retained as historical reference only.

## Historical Source Update Flow
...
The former public installer and release flow are no longer available.
...
Check the [GitHub Releases](https://github.com/the-brain-dev/The-Brain/releases) page and package changelogs for migration notes. Breaking changes are documented in `### Breaking Changes` sections of each package's CHANGELOG.md.
