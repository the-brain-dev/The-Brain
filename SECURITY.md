...
If you discover a security vulnerability in the-brain, please **do not** open a public issue.

Instead, email the maintainers privately at:

**security <at> the-brain.dev**

We will respond within 48 hours and work with you to resolve the issue.

## Scope

the-brain handles sensitive data:
...
- All data is stored locally in `~/.the-brain/` by default
