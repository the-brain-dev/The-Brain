---
title: End-to-End Tutorial (Archived)
description: Historical the-brain workflow from project setup to context injection
---

> **DEPRECATED — PROJECT ARCHIVED.** This tutorial documents a former the-brain workflow for historical reference. The project is no longer maintained and should not be installed for new projects.

This tutorial walks through the former the-brain workflow with a real React project. The commands below are not a supported installation or operating procedure.

## Historical Prerequisites

- macOS with Apple Silicon (for the former MLX workflow — optional)
- [Bun](https://bun.sh) was used by the former workflow
- A React project for reviewing the historical example

## Step 1: Install the-brain (Historical)

The former public installer has been removed. No supported installation or version-verification path remains; continue only if you are reviewing an existing historical checkout.

## Step 2: Initialize with Your Project (Historical)
...
## Step 3: Start the Daemon (Historical)
...
|------|---------|-------------|
| Historical setup | Public installer removed | Bun + CLI + LaunchAgents |
...
This workflow is preserved as project history. It is not maintained or supported.
