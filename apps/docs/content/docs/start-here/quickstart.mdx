---
title: Quickstart (Archived)
description: Historical the-brain runtime walkthrough
---

> **DEPRECATED — PROJECT ARCHIVED.** This quickstart describes historical behavior only. the-brain is no longer maintained and should not be installed for new projects.
